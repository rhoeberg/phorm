...
set libraryFlags=glfw3dll.lib OpenGL32.lib glew32.lib portaudio_x64.lib vulkan-1.lib /link /LIBPATH:"..\3rdparty\glfw\lib" /LIBPATH:"..\3rdparty\glew\lib\Release\x64" /LIBPATH:"..\3rdparty" /LIBPATH:"..\3rdparty\portaudio\lib" /LIBPATH:"%VULKAN_PATH%\Lib"
